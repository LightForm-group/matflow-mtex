...
SNIPPETS_ARG_TYPES = {
    ...
    'get_EBSD_orientations_from_CTF_file': {},
    'get_EBSD_orientations_from_CRC_file': {},
    'get_ODF_from_EBSD_orientations': {},
    'randomly_sample_EBSD_orientations': {'ensure_types': {'numOrientations': 'double'}},
